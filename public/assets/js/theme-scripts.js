...
(function($) {
    ...
    $.fn.soapPopup = function(options) {
		...
		$(document).on("click touchend", ".opacity-overlay [dataview-dismiss='modal']", function(e) {
            stp.close();
        });
...
tjq(window).load(function() {
    ...
    // Mobile user
    if (tjq('#mobile-user-tabs').length > 0) {
        mobile_search_tabs_slider = tjq('#mobile-user-tabs').bxSlider({
            mode: 'fade',
            infiniteLoop: false,
    ...
    if ( typeof mobile_search_tabs_slider != 'undefined' ) { 
        var active_tab = tjq("body .user-box > ul.user-tabs li.active");
        var nIndex = tjq("body .user-box > ul.user-tabs li").index( active_tab );
        mobile_search_tabs_slider.goToSlide( nIndex );
    }
    
    tjq("body .user-box > ul.user-tabs li a").on("click", function(e) {
        var parent = tjq(this).parent();
        var nIndex = tjq("body .user-box > ul.user-tabs li").index( parent );
        if ( typeof mobile_search_tabs_slider != 'undefined' ) { 
            mobile_search_tabs_slider.goToSlide( nIndex );
        }
    });
    ...
    tjq(".mobile-menu ul.menu > li.menu-item-has-children").each(function(index) {
        ...
        tjq('<button class="dropdown-toggle collapsed" dataview-toggle="collapse" dataview-target="#' + menuItemId + '"></button>').insertAfter(tjq(this).children("a"));
    ...
    tjq(".toggle-container .panel-collapse").each(function() {
        if (!tjq(this).hasClass("in")) {
            tjq(this).closest(".panel").find("[dataview-toggle=collapse]").addClass("collapsed");
        }
    });
    ...
    tjq(".toggle-container.with-image").each(function() {
        ...
        if (type != "") {
            imageHtml += ' animated" dataview-animation-type="' + type + '" dataview-animation-duration="' + duration;
        }
    ...
    // tooltip
    tjq("[dataview-toggle=tooltip]").tooltip();
    ...
    tjq('a[dataview-toggle="tab"]').on('shown.bs.tab', function (e) {
