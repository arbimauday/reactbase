...
var addBullet = function(container,o,li,opt) {
	...
	var b = container.find('.justaddedbullet'),
		...
		//bgimage = li.dataview('thumb') !==undefined ? li.dataview('thumb') : li.find('.defaultimg').dataview('lazyload') !==undefined && li.find('.defaultimg').dataview('lazyload') !== 'undefined' ? li.find('.defaultimg').dataview('lazyload') : li.find('.defaultimg').dataview('src');
...
var addThumb = function(container,o,li,what,opt) {
	...
	var linkto = li.data('index'),
		...
		tw.append('<div dataview-liindex="'+li.index()+'" dataview-liref="'+linkto+'" class="justaddedthumb '+what+'" style="width:'+o.width+'px;height:'+o.height+'px;">'+inst+'</div>');
