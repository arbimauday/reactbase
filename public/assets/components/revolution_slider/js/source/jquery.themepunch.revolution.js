 ...
 var runSlider = function(container,opt) {
	...
	jQuery.each(opt.allli,function(index,li) {
		...
		if (li.data('link')!=undefined) {
			...
			var apptxt = '<div class="tp-caption slidelink" style="cursor:pointer;width:100%;height:100%;z-index:'+zindex+';" dataview-x="center" dataview-y="center" dataview-basealign="slide" ',
				jts = linktoslide==="scroll_under" ? '[{"event":"click","action":"scrollbelow","offset":"100px","delay":"0"}]' : 
					 linktoslide==="prev" ? '[{"event":"click","action":"jumptoslide","slide":"prev","delay":"0.2"}]' : 
					 linktoslide==="next" ? '[{"event":"click","action":"jumptoslide","slide":"next","delay":"0.2"}]' : '[{"event":"click","action":"jumptoslide","slide":"'+linktoslide+'","delay":"0.2"}]'
			
			apptxt = linktoslide=="no" ? apptxt +' dataview-start="0">' : apptxt + 'dataview-actions='+"'"+jts + "'"+' dataview-start="0">';
...
var letItFree = function(container,opt,nextsh,actsh,nextli,actli,mtl) {
	...
	opt.c.attr('dataview-slideactive',container.find('.active-revslide').data('index'));
