            ...
            <footer id="footer">
                <div className="footer-wrapper">
                    <div className="container">
                        <div className="main-menu tab-container full-width-style clearfix">
                            <div className="tab-content pull-right">
                                {/*<nav id="main-menu" role="navigation" className="hidden-mobile inline-block">
                                    <ul className="menu">
                                        <li className="menu-item-has-children menu-color-blue">
                                        ...
                                        <li className="menu-item-has-children megamenu-menu menu-color-blue">
                                            <a href="#">Pages</a>
                                            <div className="megamenu-wrapper container" data-items-per-column="8">
                                                <div className="megamenu-holder">
